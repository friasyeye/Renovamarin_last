...
export const metadata: Metadata = {
  title: "Reformas de baños en Barcelona | Renovamarín",
  description:
    "Transformamos tu baño de arriba abajo. Instalación completa, materiales a tu gusto y entrega en el plazo que acordamos.",
};
...
const checklist = [
  ...
  "Alicatado de suelo y paredes",
  "Instalación de mueble de baño y accesorios",
        ...
        <section className="relative bg-white px-5 pb-16 pt-24 md:px-8 md:pt-28">
          <div className="mx-auto w-full max-w-[1280px]">
            ...
            <Reveal as="nav" variant="fade" immediate className="mb-10 flex items-center gap-2 font-sans text-[12px] font-medium tracking-[0.12em] uppercase">
              ...
              <span className="text-[var(--color-stone)]/25">/</span>
              <span className="text-[var(--color-red)]">Reformas de baños</span>
            </Reveal>
        ...
        <div className="bg-[linear-gradient(to_bottom,#ffffff_0%,#ffffff_50%,var(--color-maroon)_50%,var(--color-maroon)_100%)] px-5 md:px-8">
          <div className="mx-auto max-w-[1280px]">
            ...
            <div className="relative aspect-[4/5] w-full overflow-hidden shadow-[0_8px_48px_rgba(43,44,44,0.22)] md:hidden">
              <Image
                src="/images/baño_or.jpg"
                alt="Reforma de baño terminada en Barcelona"
                fill
          ...
          <div className="mx-auto grid max-w-[1280px] gap-16 pt-16 md:grid-cols-[1fr_1fr] md:gap-28 md:pt-24">
            ...
            <Reveal delay={100}>
              <p className="font-sans text-[15px] leading-[1.75] text-[var(--color-cream)]/65 md:text-[17px]">
                El baño es el espacio que más se deteriora con el tiempo y el que más se agradece cuando está bien hecho. Una reforma de baño completa no es solo cambiar los azulejos — es impermeabilizar bien, renovar la fontanería, elegir los materiales correctos y dejar todo funcionando a la perfección.
              </p>
              <p className="mt-5 font-sans text-[15px] font-semibold leading-[1.75] text-[var(--color-cream)] md:text-[17px]">
                Nos encargamos de todo y te mantenemos informado en cada paso. Cuando terminamos, recogemos y dejamos el espacio listo para usar.
              </p>
            </Reveal>
